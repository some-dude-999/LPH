...
### The Rule
- ❌ **NEVER** create any markdown (.md) files
- ❌ **NEVER** create any text (.txt) files
- ✅ **ONLY EXCEPTION**: `PythonHelpers/link_manager.py` automatically generates `LINK.txt`

### Why This Matters
- Documentation belongs in code comments (see KEY FEATURES section)
- Markdown files create maintenance burden and get outdated
- The only documentation file is CLAUDE.md (this file)
- LINK.txt is auto-generated by a script, not manually created

### What to Do Instead
- ✅ Document features in code comments using KEY FEATURE blocks
- ✅ Put architectural notes in CLAUDE.md if absolutely necessary
- ✅ Use git commit messages for change documentation
- ❌ Don't create separate .md files for plans, reports, or summaries
- ❌ Don't create .txt files for notes or documentation
