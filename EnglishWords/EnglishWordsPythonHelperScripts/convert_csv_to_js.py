...
Output:
    - Clean JS files: EnglishWords/Jsmodules/actN-name.js
    - Obfuscated JS files: EnglishWords/Jsmodules-js/actN-name-js.js
...
ACT_NAMES = {
    ...
    "Act III: Everyday Life": "act3-everyday-life",
    "Act IV: Expanding Horizons": "act4-expanding-horizons",
    "Act V: Advanced Mastery": "act5-advanced-mastery"
}
...
ACT_TO_NUMBER = {
    ...
    "Act III: Everyday Life": 3,
    "Act IV: Expanding Horizons": 4,
    "Act V: Advanced Mastery": 5
}
